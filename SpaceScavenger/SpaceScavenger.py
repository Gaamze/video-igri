...
def main():
    ...
    # audio files
    BACKGROUND_MUSIC = "assets/sounds/space-scavenger_assets_sounds_background_music.wav"
    CLASH_SOUND = pygame.mixer.Sound("assets/sounds/space-scavenger_assets_sounds_clash_sound.wav")
